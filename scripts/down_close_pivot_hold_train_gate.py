#!/usr/bin/env python3
"""Train-only gate for the frozen down-close pivot-hold entry."""
...
def main() -> None:
    ...
    ap.add_argument("--output-dir", default="backtests/down_close_pivot_hold_v2/results")
    ...
    report = {
        ...
        "frozen_spec": "backtests/down_close_pivot_hold_v2/frozen_spec.md",
    ...
    path = out / f"down_close_pivot_hold_train_{stamp}.json"
